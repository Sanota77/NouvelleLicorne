<nav class="navbar navbar-expand-lg navbar-light bg-light opacitynav">
<a href ="index.php" ><img class="Logo" src="./img/Logo.png" alt="Logo NouvelleLicorne"></a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="justify-content: space-around !important">
